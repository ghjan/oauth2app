...
* See https://github.com:ghjan/oauth2app for source code.
...
If easy_install is available, you can use: ::
    ...
    easy_install https://github.com:ghjan/oauth2app/tarball/master
...
An `example Django project <https://github.com:ghjan/oauth2app/tree/develop/examples/mysite>`_ demonstrating client and server functionality is available in the repository.

https://github.com:ghjan/oauth2app/tree/develop/examples/mysite
